...
def initialize(ERROR_THRESH):
	...
	#BASELINES.append(MultivariateHierarchical('hier', error_thresh = ERROR_THRESH, blocksize=4096*4, start_level = 10, trc = True))
...
def run(BASELINES,\
	...
	data = np.load(DATA_DIRECTORY + FILENAME, allow_pickle = True)[:4096*64,:]
...
for t in error_thresholds:
	...
	"""
	try:
		with open('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/results/results_compression_r_' + FILENAME.split('.')[0] + '.txt', 'x') as f:
			f.write('[')
		...
		with open('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/results/results_compression_r_' +FILENAME.split('.')[0] + '.txt','a') as f:
			f.write('[')
			[f.write(str(bresults[k]['compressed_ratio'])+',') if k != 'apca' else f.write(str(bresults[k]['compressed_ratio'])) for k in bresults]
			f.write(']')
			f.write(',')
	...
	try:
		with open('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/results/results_compression_l_' + FILENAME.split('.')[0] + '.txt', 'x') as f:
			f.write('[')
		...
		with open('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/results/results_compression_l_' +FILENAME.split('.')[0] + '.txt','a') as f:
			f.write('[')
			[f.write(str(bresults[k]['compression_latency'])+',') if k != 'apca' else f.write(str(bresults[k]['compressed_ratio'])) for k in bresults]
			f.write(']')
			f.write(',')
	...
	try:
		with open('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/results/results_decompression_l_' + FILENAME.split('.')[0] + '.txt', 'x') as f:
			f.write('[')
		...
		with open('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/results/results_decompression_l_' +FILENAME.split('.')[0] + '.txt','a') as f:
			f.write('[')
			[f.write(str(bresults[k]['decompression_latency'])+',') if k != 'apca' else f.write(str(bresults[k]['compressed_ratio'])) for k in bresults]
			f.write(']')
			f.write(',')
