...
# data = np.load('/Users/gabemersy/Desktop/ts_compression/synthetic_TS_gen/big_duos/corrcoef_0.99.npy')
# data = np.load('/Users/gabemersy/Desktop/data/solar.npy')
#data = np.load('/Users/brunobarbarioli/Documents/Research/ts_compression/l2c/data/phones_accelerometer.npy')[:4096*2048,1:2]
