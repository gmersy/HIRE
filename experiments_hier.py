...
for t in error_thresholds:
	...
	try:
		with open('/Users/-/Documents/Research/ts_compression/l2c/results/results_compression_r_hier_' + FILENAME.split('.')[0] + '.txt', 'x') as f:
			#f.write('[')
		...
		with open('/Users/-/Documents/Research/ts_compression/l2c/results/results_compression_r_hier_' +FILENAME.split('.')[0] + '.txt','a') as f:
			#f.write('[')
			[f.write(str(bresults[k]['compressed_ratio'])+',') if k != 'apca' else f.write(str(bresults[k]['compressed_ratio'])) for k in bresults]
			#f.write(']')
			#f.write(',')
	...
	try:
		with open('/Users/-/Documents/Research/ts_compression/l2c/results/results_compression_l_hier_' + FILENAME.split('.')[0] + '.txt', 'x') as f:
			#f.write('[')
		...
		with open('/Users/-/Documents/Research/ts_compression/l2c/results/results_compression_l_hier_' +FILENAME.split('.')[0] + '.txt','a') as f:
			#f.write('[')
			[f.write(str(bresults[k]['compression_latency'])+',') if k != 'apca' else f.write(str(bresults[k]['compressed_ratio'])) for k in bresults]
			#f.write(']')
			#f.write(',')
	...
	try:
		with open('/Users/-/Documents/Research/ts_compression/l2c/results/results_decompression_l_hier_' + FILENAME.split('.')[0] + '.txt', 'x') as f:
			#f.write('[')
		...
		with open('/Users/-/Documents/Research/ts_compression/l2c/results/results_decompression_l_hier_' +FILENAME.split('.')[0] + '.txt','a') as f:
			#f.write('[')
			[f.write(str(bresults[k]['decompression_latency'])+',') if k != 'apca' else f.write(str(bresults[k]['compressed_ratio'])) for k in bresults]
			#f.write(']')
			#f.write(',')
